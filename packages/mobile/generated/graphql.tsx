...
export type Morph =
  ...
  | TestGroupBy
  | TestConnectionId
  | TestConnectionCreated_At
  | TestConnectionUpdated_At
  | TestConnectionTeest
  | TestConnectionBool
  | TestConnectionUser
  | TestConnectionCreated_By
  | TestConnectionUpdated_By
  | CreateTestPayload
  | UpdateTestPayload
  | DeleteTestPayload
  | UploadFile
...
export type MeQuery = {__typename?: 'Query'} & {
  me?: Maybe<
    {__typename?: 'UsersPermissionsMe'} & Pick<UsersPermissionsMe, 'email'>
  >;
};
